...
class ModelUser {
  ...
  putUsuario(id, nome = null, endereco = null, email = null, fone = null) {
    this._nome      = ( typeof nome         !== 'string' || nome      === "undefined" ) ? this.destroy(nome) : nome;
    this._endereco  = ( typeof endereco     !== 'string' || endereco  === "undefined" ) ? this.destroy(endereco)  : endereco;
    this._email     = ( typeof email        !== 'string' || email     === "undefined" ) ? this.destroy(email)        : email;
    this._fone      = ( typeof fone         !== 'string' || fone      === "undefined" ) ? this.destroy(fone)        : fone;
